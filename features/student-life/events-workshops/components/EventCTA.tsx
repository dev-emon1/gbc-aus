      ...
      <div className={CONTAINER}>
        <MotionReveal>
          <div className="relative overflow-hidden rounded-[36px] border border-slate-200 bg-gradient-to-r from-[#D84D95]/8 via-white to-[#B7D531]/12 p-8 lg:p-12">
            ...
            <div className="absolute -right-24 -bottom-24 h-72 w-72 rounded-full bg-[#B7D531]/15 blur-[130px]" />
            ...
            <div className="relative z-10 flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="max-w-2xl">
                ...
                <p className="mt-5 text-lg leading-8 text-slate-600">
                  Participate in workshops, networking sessions, cultural
                  celebrations and student activities designed to enrich your
                  college experience and help you build valuable connections.
                </p>
              </div>
